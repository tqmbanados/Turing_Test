...
//THESE UDOS ASSUME A CERTAIN FRAMEWORK FOR OOP CODING
...
giAmpFactor = 2.5
giPlayback = 0 //1 if mic3 should be played through csound
...
instr Chassis
	...
	schedule "Setup1", 0, 1
	if nchnls > 3 then
		schedule "Master4", 0, p3
	else 
		schedule "Master2", 0, p3
	endif
...
instr Setup1
	chnset 0, "growth"
	chnset -6, "masterdB"
	chnset -16, "global_in_gain"
	
	chnset 0, "push_upper_db"
	chnset -60, "push_lower_db"
	chnset 37, "push_env_detect"
...
*/
	...
	kIntensity GetAttr "reactionLevel"
	...
	kPowered = pow:k(kAmpIn * kAmpFactor, kIntensity)
	kPowered = limit(kPowered, 0.25, 2)
	aAmp = interp(kPowered)
	xout aAmp
endop

opcode PingPongFFTGranulator, a, iikaakk
...
*/
	iFnTable1, iFnTable2, kPositionVariation, aPosition1, aPosition2, kMin, kMSize xin
	kMax = kMin + kMSize
...
*/
	...
	if kDB >= kPeakDB then
		...
		kMinFreq = limit(kMinFreq - (1/(iHalfLife * 3 * kr)), 0.1, 2)
		kMaxFreq = limit(kMaxFreq - (1/(iHalfLife * 3 * kr)), 0.3, 2)
	endif
	...
	kPeakDB = limit(kPeakDB + (-12/(iHalfLife * kr)), -90, 1)
	//printk 1, kPeakDB
	xout kPlay
endop
...
instr SingleSeed
	...
	aMorphedText PingPongFFTGranulator iTable1, iTable2, k(iVariability), aIdx1, aIdx2, kMin, kPeriod

	// Calculate Env
	aREnv GetAttr "reactiveEnv"
	kGlobalEnv GetAttr "globalEnv"
	kEnv = linen:k(kGlobalEnv, 0.6, p3, 0.5)
	aEnv = aREnv * kEnv
	
	kGlobalDB GetAttr "global_db"
	kAmp ampdb kGlobalDB
	aOut = aMorphedText * aEnv * kAmp
	SendAll(aOut)
endin
...
opcode CroakRhythmicEnvelope, k, 0
	...
	*/
	...
	if gkPeakPossible == 0 then
		kMinFreq = limit(kMinFreq + (12/(kr)), 0.5, 5)
		kMaxFreq = limit(kMaxFreq + (8/(kr)), 1, 8)
	else 
		kMinFreq = limit(kMinFreq - (5/(iHalfLife * kr)), 0.5, 5)
		kMaxFreq = limit(kMaxFreq - (3/(iHalfLife * kr)), 1, 8)
	endif
...
instr Croak
	...
	*/
	...
	kGrowth = line:k(ginBufferSize, 120, 0)
	SetAttr "growth", kGrowth
	...
	if kTrig == 1 then
		...
		schedulek "LowWave", 0.01, random:k(kMinDur, 2/kClickSpeed), "croak", 1, giMicin1, kGrowth * 90
		schedulek "LowWave", 0.01, random:k(kMinDur, 2/kClickSpeed), "croak", 1, giMicin2, kGrowth * -90
	endif 	
...
instr LowWave
	...
	*/
	...
	aRevL, aRevR freeverb aOuts[0], aOuts[1], 0.6, 1
	OutArray aOuts
	chnmix aRevL, "EOut2"
	chnmix aRevR, "EOut3"
endin
...
instr Click
	...
	iAzim = random:i(0, iGrowth * iQuality * 10)
...
opcode Morphing, a, aak
	...
	fSig2 pvsanal aSignal2, gifftsize, gioverlap, gifftsize, giwintype
 	fMorphed pvsmorph fSig1, fSig2, kMorph, kMorph
  	fSmoothed pvsmooth fMorphed, 0.1, 0.1 // we add a bit of smoothing to reduce artifacts
...
opcode GetAttack, k, ikk
	...
	if kChanged <= 0.01 then
		if iReverse == 0 then
			...
			if kInDB > gkPushLowerDBLimit then
				kSwitch = 1
				kChanged = 1
			else
				kSwitch = 0
...
instr Push
	...
	if kTrigger == 1 then
		...
		if kSwitch == 1 then
			...
			schedulek "Attack", 1/kr, 0.7, "push", kStart, kTurnoff, iReverse
...
instr Attack
	...
	iStart = p5
	if p6 == 0 then
		kAttackEnv = transeg:k(iStart, 0.3, 6, 1.7, 0.4, -2, 0.8)
...
<bsbPanel>
 ...
 <bsbObject version="2" type="BSBController">
  ...
  <xValue>0.66958891</xValue>
  <yValue>0.66958891</yValue>
  <type>fill</type>
 ...
 <bsbObject version="2" type="BSBController">
  ...
  <yMin>0.00000000</yMin>
  <yMax>1.00000000</yMax>
  <xValue>0.67151151</xValue>
  <yValue>0.67151151</yValue>
  <type>fill</type>
  <pointsize>1</pointsize>
  <fadeSpeed>0.00000000</fadeSpeed>
  <mouseControl act="press">jump</mouseControl>
 ...
 <bsbObject version="2" type="BSBController">
  ...
  <yMin>0.00000000</yMin>
  <yMax>1.00000000</yMax>
  <xValue>0.57527142</xValue>
  <yValue>0.57527142</yValue>
  <type>fill</type>
  <pointsize>1</pointsize>
  <fadeSpeed>0.00000000</fadeSpeed>
  <mouseControl act="press">jump</mouseControl>
 ...
 <bsbObject version="2" type="BSBController">
  ...
  <yMin>0.00000000</yMin>
  <yMax>1.00000000</yMax>
  <xValue>0.57124279</xValue>
  <yValue>0.57124279</yValue>
  <type>fill</type>
  <pointsize>1</pointsize>
  <fadeSpeed>0.00000000</fadeSpeed>
  <mouseControl act="press">jump</mouseControl>
 ...
 <bsbObject version="2" type="BSBController">
  ...
  <yMin>0.00000000</yMin>
  <yMax>1.00000000</yMax>
  <xValue>0.34627124</xValue>
  <yValue>0.34627124</yValue>
  <type>fill</type>
  <pointsize>1</pointsize>
  <fadeSpeed>0.00000000</fadeSpeed>
  <mouseControl act="press">jump</mouseControl>
 ...
 <bsbObject version="2" type="BSBVSlider">
  <objectName>seed.reactionLevel</objectName>
  <x>53</x>
  <y>453</y>
  <width>25</width>
  <height>125</height>
 ...
 <bsbObject version="2" type="BSBHSlider">
  ...
  <maximum>26.00000000</maximum>
  <value>-1.21266968</value>
  <mode>lin</mode>
  <mouseControl act="jump">continuous</mouseControl>
  <resolution>-1.00000000</resolution>
  <randomizable group="0">false</randomizable>
 ...
 <bsbObject version="2" type="BSBController">
  ...
  <yMin>0.00000000</yMin>
  <yMax>1.00000000</yMax>
  <xValue>0.93933640</xValue>
  <yValue>0.93933640</yValue>
  <type>fill</type>
  <pointsize>1</pointsize>
  <fadeSpeed>0.00000000</fadeSpeed>
  <mouseControl act="press">jump</mouseControl>
 ...
 <bsbObject version="2" type="BSBController">
  ...
  <yMin>0.00000000</yMin>
  <yMax>1.00000000</yMax>
  <xValue>0.93883046</xValue>
  <yValue>0.93883046</yValue>
  <type>fill</type>
  <pointsize>1</pointsize>
  <fadeSpeed>0.00000000</fadeSpeed>
  <mouseControl act="press">jump</mouseControl>
 ...
 <bsbObject version="2" type="BSBController">
  ...
  <xValue>-72.09917854</xValue>
  <yValue>-72.09917854</yValue>
  <type>fill</type>
  <pointsize>1</pointsize>
  <fadeSpeed>0.00000000</fadeSpeed>
  <mouseControl act="press">jump</mouseControl>
