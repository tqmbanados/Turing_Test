...
vbaplsinit 2, 7, -45, 45, 80, -155, -170, -70, 0

////// GLOBAL Params //////
giRecord = 0 // if 1 then record
...
opcode SReverb, a, akk
	aInC, iSizeAlter, iHCAlter xin
	kRevSize chnget "reverbSize"
	kRevHC chnget "reverbHC"
	
	aRevC nreverb aInC, kRevSize * iSizeAlter, limit(kRevHC * iHCAlter/15000, 0.1, 1.0)
...
instr Master
	...
	aOut3, aOut6 SReverb aOut3, aOut6, 0.96, 0.9
	aOut4, aOut5 SReverb aOut4, aOut5, 1.2, 0.8
	aOut7 SReverb aOut7, 1.0, 1.3
	...
	if nchnls >= 4 then
		out aOut1, aOut2, aOut3, aOut4, aOut5, aOut6, aOut7
	else
...
instr Recorder
	...
	if nchnls <= 2 then
		...
		CsQtMeter "out1", "out1_over", aElekOuts[0] + aElekOuts[6], kTrigDisp
		CsQtMeter "out2", "out2_over", aElekOuts[1] + aElekOuts[6], kTrigDisp
		CsQtMeter "out3", "out3_over", aElekOuts[2] + aElekOuts[3], kTrigDisp
		CsQtMeter "out4", "out4_over", aElekOuts[4] + aElekOuts[5], kTrigDisp
	endif
...
<bsbPanel>
 ...
 <bsbObject type="BSBController" version="2">
  ...
  <yMin>0.00000000</yMin>
  <yMax>1.00000000</yMax>
  <xValue>0.17380082</xValue>
  <yValue>0.17380082</yValue>
  <type>fill</type>
  <pointsize>1</pointsize>
  <fadeSpeed>0.00000000</fadeSpeed>
  <mouseControl act="press">jump</mouseControl>
 ...
 <bsbObject type="BSBController" version="2">
  ...
  <yMin>0.00000000</yMin>
  <yMax>1.00000000</yMax>
  <xValue>0.30644749</xValue>
  <yValue>0.30644749</yValue>
  <type>fill</type>
  <pointsize>1</pointsize>
  <fadeSpeed>0.00000000</fadeSpeed>
  <mouseControl act="press">jump</mouseControl>
 ...
 <bsbObject type="BSBController" version="2">
  ...
  <yMin>0.00000000</yMin>
  <yMax>1.00000000</yMax>
  <xValue>0.09577308</xValue>
  <yValue>0.09577308</yValue>
  <type>fill</type>
  <pointsize>1</pointsize>
  <fadeSpeed>0.00000000</fadeSpeed>
  <mouseControl act="press">jump</mouseControl>
